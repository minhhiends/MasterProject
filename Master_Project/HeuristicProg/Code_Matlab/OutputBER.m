function OutputBER
load('varicurrent')
file_name = strcat('/home/minhhien/Documents/Result_master/BERk',num2str(k),'m',num2str(M), 'D',num2str(D),'.csv');
%file_name = strcat('/home/minhhien/Documents/topoFSO/input_output_Topo/BERk',num2str(k),'m',num2str(M), 'D',num2str(D));
