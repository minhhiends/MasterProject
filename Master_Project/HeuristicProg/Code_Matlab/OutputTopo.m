function OutputTopo
load('varicurrent')
name_fileTopo=strcat('/home/minhhien/Documents/Result_master/outputTopoHeur',num2str(k),'M',num2str(M), 'D',num2str(D),'.txt');
%name_fileTopo=strcat('/home/minhhien/Documents/topoFSO/input_output_Topo/outputTopoHeur',num2str(k),'M',num2str(M), 'D',num2str(D),'.txt');
